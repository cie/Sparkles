...
void draw() {
  ...
  fill(0,200); noStroke();
  rect(40, 40, width/2-100, height-120, 5);
  fill(255);
  text(
"Az ablak tetején lévő csőben egy\n"+
"fekete és egy fehér folyadékot\n"+
"tettünk egymás mellé, és hagyjuk,\n"+
"hogy diffúzió útján keveredjenek.\n"+
"A piros görbe a folyadékok \n"+
"részarányát mutatja, a kék görbe\n"+
"ennek deriváltja.\n"+
""
  , 50, 60);
}
